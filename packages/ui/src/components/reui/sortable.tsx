...
function Sortable<T>({
  ...
  const itemIds = useMemo(() => {
    ...
    // Unconditional: upstream gated this on `process.env.NODE_ENV`, which this
    // package has neither types nor a bundler shim for. A duplicate id breaks
    // dragging silently, so the warning earns its bytes in production too.
